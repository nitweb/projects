    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h3>Add Replace Product</h3>
                        <form action="{{ route('store.replace.product') }}" method="POST" class="custom-validation" novalidate="">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="return_no" class="col-sm-12 col-form-label">Return No</label>
                                        <input class="form-control" type="text" name="return_no"
                                            value="{{ $return_no }}" id="return_no" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
