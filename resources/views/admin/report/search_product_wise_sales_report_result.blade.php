        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 text-muted ">Filtering Product wise Sales Report Result</h4>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="table-responsive" id="printContent">
                    <h4 class="text-muted text-center">Sales of
                    ...
                    <table class="table table-bordered" id="" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @php
                                $total = 0;
                            @endphp
                            @foreach ($allProductDetails as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                        {{ $item['product']['name'] }}
