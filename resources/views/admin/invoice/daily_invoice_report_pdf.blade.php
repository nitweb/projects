                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active"><span class="text-capitalize">{{ $report_head }} </span> Report</li>
                            </ol>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12 mt-4">
                                            <h3 class="text-muted text-center mb-4"><span class="text-capitalize">{{ $report_head }} </span> Report from
