                    ...
                    <div class="card-body">
                        <form action="{{ route('invoice.store') }}" method="POST" class="custom-validation" novalidate=""
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="md-3">
                                        <label for="employee_id" class="col-sm-12 col-form-label">Employee Name</label>
                                        <select name="employee_id" id="employee_id" class="form-control form-select select2"
                                            required="" data-parsley-required-message="Employee Id is required">
                                ...
                                <div class="col-md-3">
                                    <div class="md-3">
                                        <label for="customer_id" class="col-sm-12 col-form-label">Customer Name</label>
